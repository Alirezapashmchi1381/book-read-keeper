...
@pytest.fixture
def use_case(fake_uow, fake_hasher, fake_tokens) -> RefreshTokenUseCase:
    return RefreshTokenUseCase(uow=fake_uow, password_hasher=fake_hasher, token_service=fake_tokens)
